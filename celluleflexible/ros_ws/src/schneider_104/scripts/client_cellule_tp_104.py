...
def retour(req):
	...
	if c.is_open():
		...
		if flag == 0 :		
			...
			flag = 1
		resp = Retour_cellule_104Response()
		...
		if coils :
			...
			resp.CP6 = coils[74]
			resp.CP7 = coils[75]
			resp.OUTR10= coils[34]
			resp.OUTR11= coils[35]
			return resp
...
if __name__ == "__main__":
	rospy.Service('retour_cellule_104', Retour_cellule_104, retour)
	rospy.Subscriber("control_cellule_104", String, callback)
	rospy.spin()
