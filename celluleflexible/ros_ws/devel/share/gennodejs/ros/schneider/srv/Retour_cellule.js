...
class Retour_celluleResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('PS6')) {
        this.PS6 = initObj.PS6
      }
      else {
        this.PS6 = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [PS6]
    bufferOffset = _serializer.bool(obj.PS6, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [PS6]
    data.PS6 = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.PS6 !== undefined) {
      resolved.PS6 = msg.PS6;
    }
    else {
      resolved.PS6 = false
    }
