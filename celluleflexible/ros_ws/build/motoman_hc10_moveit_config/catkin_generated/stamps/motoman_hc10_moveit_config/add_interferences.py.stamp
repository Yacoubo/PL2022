...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def add_interferences(self, timeout=4):
    ...
    scene = self.scene
    robot = self.robot
    #xBloc = [[-150, 150], [-990, 1150], [-900, 900], [200, 900], [-900, -200], [-200, 200], [900, 1150], [900, 910], [-910, -900], [-900, 900]]
    #yBloc = [[200, 350], [-860, 1530], [320, 920], [-900, 320], [-900, 320], [-900, -200], [50, 270], [-900, 920], [-900, 920], [-900, -910]]
    ...
    zBloc = [[-500, -150], [-500, 1530], [-500, 360], [-500, -260], [-500, -260], [-500, -260], [-500, 1350], [-500, 2300],[-500, 2300], [-500, 2300]]
    name = ["cables", "zone_travail", "chariot", "plan_part1", "plan_part3", "plan_part2", "poteau", "mur_y_pos", "mur_y_neg", "mur_x_pos"]
    dilatation = 25 # mm
